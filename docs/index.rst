...
.. warning::
   ...
   **This library and this documentation were written by an AI.** Every line of
   ...
   Read that as a reason to check things, not as a reason to dismiss them. What
   it means in practice:

   * **The device behaviour is measured, not invented.** Protocol details,
...
**The same operations on every protocol a switch speaks.** Nine reads and ten
...
**Plus switches, not just managed ones.** The GS110EMX, GS305EP and GS105PE have
